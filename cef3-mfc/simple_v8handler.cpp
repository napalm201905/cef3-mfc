...
SimpleV8Handler::SimpleV8Handler(CefRefPtr<CefApp> app)
{
	this->app = app;
}


SimpleV8Handler::~SimpleV8Handler()
{
}

bool SimpleV8Handler::Execute(const CefString& name, CefRefPtr<CefV8Value> object, 
